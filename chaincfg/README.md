...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/aBitcoinDiamond/chaincfg)
...
```bash
$ go get -u github.com/aBitcoinDiamond/chaincfg
```
