...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/aBitcoinDiamond/integration/rpctest)
...
```bash
$ go get -u github.com/aBitcoinDiamond/integration/rpctest
```
