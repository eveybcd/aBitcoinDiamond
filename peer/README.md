...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/aBitcoinDiamond/peer)
...
```bash
$ go get -u github.com/aBitcoinDiamond/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/aBitcoinDiamond/peer#example-package--NewOutboundPeer)  
